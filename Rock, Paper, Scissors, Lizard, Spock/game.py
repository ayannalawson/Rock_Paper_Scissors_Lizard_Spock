...
class Game:
    ...
    # As a player, I want the correct player to win a given round based on the chices made by each player.
    # As a player, Iw ant the game of RPSLS to be a minimum a "best out of three" to decide a winner.
    # As a player, I want the option of a single player (human vs. AI) or a multiplayer (Human vs. Human) game.
    
    
    # Please correct me if I'm worng! Please let me know how to improve, I look forward to hearing from you!